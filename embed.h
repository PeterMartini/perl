...
#define cv_get_signature_pv(a)	S_cv_get_signature_pv(aTHX_ a)
#define cv_set_call_checker(a,b,c)	Perl_cv_set_call_checker(aTHX_ a,b,c)
#define cv_set_signature_pv(a,b)	S_cv_set_signature_pv(aTHX_ a,b)
...
#define magic_copysig(a,b,c,d,e)	Perl_magic_copysig(aTHX_ a,b,c,d,e)
